...
if ( ! function_exists( 'gymnaz_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function gymnaz_posted_on() {
...
if ( ! function_exists( 'gymnaz_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function gymnaz_posted_by() {
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html( '%s', 'post author', 'gymnaz' ),
...
if ( ! function_exists( 'gymnaz_post_comments' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time and author.
	 */
	function gymnaz_post_comments() {
...
if ( ! function_exists( 'gymnaz_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function gymnaz_entry_footer() {
...
if ( ! function_exists( 'gymnaz_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function gymnaz_post_thumbnail() {
...
if( ! function_exists( 'gymnaz_fontawesome_social_icons_lists' ) ) :
	/**
     * Font Awesome
     *
	...
	function gymnaz_fontawesome_social_icons_lists() {
