<?php
/**
 * View: Organizers List - Card View
 *
 * Override this template in your own theme by creating a file at:
 * [your-theme]/eventprime/organizers/list/views/card.php
 *
 */
?>
<?php foreach ( $args->organizers->terms as $organizer ) { ?>
    <div class="ep-box-col-<?php echo $args->cols; ?> ep-col-md-6 ep-mb-3 ss">
        <div class="ep-box-card-item">
            <div class="ep-box-card-thumb" >
                ...
                if ( ! empty( $organizer->em_social_links ) ) {?>
                    <div class="ep-box-card-social ep-organizers-social"><?php
                        if ( isset( $organizer->em_social_links['facebook'] ) ) {?>
                            <a href="<?php echo esc_url( $organizer->em_social_links['facebook'] );?>" target="_blank" title="Facebook">
                        ...
                        if ( isset( $organizer->em_social_links['instagram'] ) ) {?>
                            <a href="<?php echo esc_url( $organizer->em_social_links['instagram'] );?>" target="_blank" title="Instagram">
                        ...
                        if ( isset( $organizer->em_social_links['linkedin'] ) ) {?>
                            <a href="<?php echo esc_url( $organizer->em_social_links['linkedin'] );?>" target="_blank" title="Linkedin">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" style="width: 18px;">
                        ...
                        if ( isset( $organizer->em_social_links['twitter'] ) ) {?>
                            <a href="<?php echo esc_url( $organizer->em_social_links['twitter'] );?>" target="_blank" title="Twitter">
