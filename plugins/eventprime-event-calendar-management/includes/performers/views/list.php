...
?>
<div class="emagic">
    <div class="ep-performers-container ep-mb-5" id="ep-performers-container">
        <?php
        ...
        if( isset( $args->performers ) && !empty( $args->performers ) ) {?>
            <div class="em_performers ep-event-performers-<?php echo $args->display_style;?>-container ep-box-wrap">
