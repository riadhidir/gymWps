<?php
/**
 * View: Performers List - Search
 *
 * Override this template in your own theme by creating a file at:
 * [your-theme]/eventprime/performers/list/search.php
 *
 */
?>
<?php if( isset( $args->enable_search ) && $args->enable_search == 1 ) {?>
    <form id="ep_performer_search_form" class="ep-box-wrap ep-box-search-form ep-box-bottom ep-mb-4" name="ep_performer_search_form" action="">
        <div class="ep-box-row ep-rounded ep-bg-light ep-border">
            ...
            <div class="ep-box-col-2 ep-event-filter-block ep-text-item-right ep-d-inline-flex ep-align-items-center">
                <?php if (  isset( $_GET['ep_search'] ) ) {
                    $performers_page_url = get_permalink(ep_get_global_settings('performers_page'));?>
