...
class EventM_Performer_Admin_Meta_Boxes {
	...
	public function ep_performer_register_meta_boxes() {
		add_meta_box(
			...
			esc_html__( 'Performers Settings', 'eventprime-event-calendar-management' ),
		...
		add_meta_box( 
			...
			__( 'Performer gallery', 'eventprime-event-calendar-management' ), 
	...
	public function ep_add_performer_gallery_box() {
		...
		<p class="ep_add_performer_gallery hide-if-no-js">
			<a href="#" 
				data-choose="<?php esc_attr_e( 'Add images to performer gallery', 'eventprime-event-calendar-management' ); ?>" 
			...
			>
				<?php esc_html_e( 'Add performer gallery images', 'eventprime-event-calendar-management' ); ?>
			</a>
		</p><?php
	}
	...
	public function ep_performer_posts_columns($defaults){
		$offset = 2;
                $performer_column = array(
                    'ep_perfomer_role' => __('Role','eventprime-event-calendar-management'),
