    ...
    <?php if( isset( $args->quick_search ) && $args->quick_search == 1 ){ ?>
        <div class="ep-box-row ep-text-small ep-mb-3 ep-py-4 ep-bg-light">
            ...
            <div class="ep-box-col-12">
                <span class="ep-p-2 ep-text-small ep-cursor ep-rounded-1 ep-mr-1 ep-mb-1 ep-bg-primary ep-bg-opacity-10 ep-filters-days" id="ep_filter_next_weekend" data-key="next_weekend"><?php esc_html_e( 'Next Weekend', 'eventprime-event-calendar-management');?></span>
                <span class="ep-p-2 ep-text-small ep-cursor ep-rounded-1 ep-mr-1 ep-mb-1 ep-bg-primary ep-bg-opacity-10 ep-filters-days" id="ep_filter_next_week" data-key="next_week"><?php esc_html_e( 'Next Week', 'eventprime-event-calendar-management');?></span>
                <span class="ep-p-2 ep-text-small ep-cursor ep-rounded-1 ep-mr-1 ep-mb-1 ep-bg-primary ep-bg-opacity-10 ep-filters-days" id="ep_filter_next_month" data-key="next_month"><?php esc_html_e( 'Next Month', 'eventprime-event-calendar-management');?></span>
                <span class="ep-p-2 ep-text-small ep-cursor ep-rounded-1 ep-mr-1 ep-mb-1 ep-bg-primary ep-bg-opacity-10 ep-filters-days" id="ep_filter_online" data-key="online"><?php esc_html_e( 'Online', 'eventprime-event-calendar-management');?></span>
            </div>
        </div>
    <?php } ?>    
            ...
            <div class="ep-box-col-6 ep-text-small">
                <div class="ep-input-group">
                    <select id="ep-filter-types" class="ep-form-control ep-form-control-sm" placeholder="<?php _e('Event Type', 'eventprime-event-calendar-management');?>">
                        <option><?php _e('Event Type', 'eventprime-event-calendar-management');?></option>
            ...
            <div class="ep-box-col-6 ep-text-small">
                <div class="ep-input-group">
                    <select id="ep-filter-venues" class="ep-form-control ep-form-control-sm" placeholder="<?php _e('Venue/ Location', 'eventprime-event-calendar-management');?>">
                        <option><?php _e('Venue / Location', 'eventprime-event-calendar-management');?></option>
