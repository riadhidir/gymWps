    ...
    <div class="ep-box-wrap">
        ...
        <div class="ep-box-row ep-py-3 ep-mb-3" id="ep-date-note" <?php if(isset($args->event) && !empty( $args->event->em_hide_event_start_date ) ) { echo 'style="display: block;"';}else{ echo 'style="display: none;"'; } ?> >
            <div class="ep-box-12 ep-mb-3">
                <div class="ep-form-check ep-form-check-inline">
                    <input class="ep-form-check-input" type="radio" name="em_event_date_placeholder" id="tbd-1" value="tbd1" <?php if( isset($args->event) && esc_attr( $args->event->em_event_date_placeholder ) == 'tbd1' ) { echo 'checked="checked"'; }?> >
                    <label class="form-check-label" for="tbd-1">
                        <img src="<?php echo esc_url( EP_BASE_URL . '/includes/events/assets/images/tbd1.png'); ?>" width="30">
                    </label>
                </div>
                <div class="ep-form-check ep-form-check-inline">
                    <input class="ep-form-check-input" type="radio" name="em_event_date_placeholder" id="tbd-2" value="tbd2" <?php if( isset($args->event) && esc_attr( $args->event->em_event_date_placeholder ) == 'tbd2' ) { echo 'checked="checked"'; }?> >
                    <label class="form-check-label" for="tbd-2">
                        <img src="<?php echo esc_url( EP_BASE_URL . '/includes/events/assets/images/tbd2.jpg' ); ?>" width="30">
                    </label>
                </div>
                <div class="ep-form-check ep-form-check-inline">
                    <input class="ep-form-check-input" type="radio" name="em_event_date_placeholder" id="tbd-3" value="tbd3" <?php if( isset($args->event) && esc_attr( $args->event->em_event_date_placeholder ) == 'tbd3' ) { echo 'checked="checked"'; }?> >
                    <label class="form-check-label" for="tbd-3">
                        <img src="<?php echo esc_url( EP_BASE_URL . '/includes/events/assets/images/tbd3.jpeg' ); ?>" width="30">
                    </label>
                </div>
                <div class="ep-form-check ep-form-check-inline">
                    <input class="ep-form-check-input" type="radio" name="em_event_date_placeholder" id="tbd-4" value="tbd4" <?php if( isset($args->event) && esc_attr( $args->event->em_event_date_placeholder ) == 'tbd4' ) { echo 'checked="checked"'; }?> >
                    <label class="form-check-label" for="tbd-4">
                        <img src="<?php echo esc_url( EP_BASE_URL . '/includes/events/assets/images/tbd4.png' ); ?>" width="30">
                    </label>
                </div>
                <div class="ep-form-check ep-form-check-inline">
                    <input class="ep-form-check-input" type="radio" name="em_event_date_placeholder" id="ep-date-custom-note" value="custom_note" <?php if( isset($args->event) && esc_attr( $args->event->em_event_date_placeholder ) == 'custom_note' ) { echo 'checked="checked"'; }?> >
