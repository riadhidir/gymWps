        ...
        <div class="ep-box-col-12">
            <div class="ep-box-row">
                <div class="ep-event-single-wrapper ep-box-col-12">
                    <div class="ep-event-list-item ep-box-row ep-bg-white ep-border ep-rounded ep-mb-4">
                        <div class="ep-box-col-3 ep-p-0 ep-bg-light ep-border-end ep-position-relative ep-list-view-image">
                            <a href="<?php echo esc_url($event_data['event_url']); ?>" class="ep-img-link" <?php echo esc_attr( $new_window );?>>
                                <?php if (!empty($event_data['image'] ) ) { ?>
                                <img src="<?php echo esc_url( $event_data['image'] ) ?>" alt="<?php echo esc_attr( $event_data['title'] ); ?>" class="ep-img-fluid ep-box-w-100 ep-list-img-fluid"><?php 
                                } else {?>
                                <img src="<?php echo esc_url( EP_BASE_URL . 'includes/assets/images/dummy_image.png' ) ?>" alt="<?php echo esc_attr( $event_data['title'] ); ?>" class="ep-img-fluid ep-box-w-100 ep-list-img-fluid"><?php 
                                }?>
                            </a>
