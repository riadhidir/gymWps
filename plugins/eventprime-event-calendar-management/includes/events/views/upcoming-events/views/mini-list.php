        ...
        <div class="ep-box-col-12 ep-mini-list">
            <div class="ep-box-row">
                <div class="ep-event-single-wrapper ep-box-col-12">
                    <div class="ep-event-list-item ep-box-row ep-border-bottom ep-mb-4 ep-pb-3 ep-text-small ep-align-items-center ep-overflow-hidden">
                            ...
                            <div class="ep-event-image">
                                <a href="<?php echo esc_url($event_data['event_url']); ?>" class="ep-img-link" <?php echo esc_attr( $new_window );?>>
                                    <?php if ( ! empty( $event_data['image'] ) ) { ?>
                                        ...
                                        <img src="<?php echo esc_url( EP_BASE_URL . 'includes/assets/images/dummy_image.png' ) ?>" alt="<?php echo esc_attr( $event_data['title'] ); ?>" class="ep-rounded-circle"><?php 
                                    }?>
                                </a>
                            </div>
                        </div>
