...
foreach( $args->events->posts as $event ) {
    ...
    if( ! empty( $event_data ) ) {?>
        <div class="ep-event-single-card ep-event-card ep-mb-3 ep-card-col-<?php echo esc_attr($args->event_args['event_cols']);?>">
            <div class="ep-upcoming-box-card-item ep-border ep-rounded-1 ep-overflow-hidden">
