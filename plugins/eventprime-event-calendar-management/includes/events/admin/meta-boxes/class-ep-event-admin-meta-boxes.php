...
class EventM_Event_Admin_Meta_Boxes {
	...
	public function __construct() {
		...
		//add_action( 'transition_post_status', array( $this, 'ep_event_published' ), 10 , 3 );
		...
		//add_action( 'pre_get_posts', array( $this, 'em_event_default_order' ), 9, 1 );
	}
	...
	public function get_new_modify_string( $start_date, $modify_string ) {
        $child_start_date1 = ep_timestamp_to_date( $start_date->getTimestamp() );
	...
	public function ep_filter_event_columns_content( $column_name, $post_id ) {
		if( $column_name == 'venue' ) {
            ...
            //$repeat_intervals = self::ep_get_recurrence_interval();
			...
			if( empty( $post_parent ) ) {
				...
				//$parent_post_url = admin_url( 'edit.php?post_type=em_event&post_status=all&filter_action=Filter&ep_parent_id='.$post_parent);
