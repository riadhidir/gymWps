        ...
        <div class="ep-box-row ep-mb-3">
            <div class="ep-box-col-12 ep-d-flex ep-items-center ep-meta-box-data">
                <div class="ep-form-check ep-form-check-inline">
                    ...
                    <label class="ep-form-check-label" for="em_all_day"><?php esc_html_e( 'It\'s an all day event', 'eventprime-event-calendar-management' );?></label>
                </div>
            </div>
        </div>
        ...
        <div class="ep-box-row ep-py-3">
            <div class="ep-box-col-12 ep-d-fle ep-items-center">
                  <div class="ep-form-check ep-form-check-inline">
                    ...
                    <label class="ep-form-check-label" for="ep-add-more-dates"><?php esc_html_e( 'Additional relevant dates', 'eventprime-event-calendar-management' ); ?></label>
                </div>  
            </div>
        </div>
        <!-- Additional Dates --->
