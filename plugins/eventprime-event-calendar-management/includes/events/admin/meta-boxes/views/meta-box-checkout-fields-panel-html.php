            ...
            <div class="ep-box-row">
                <div class="ep-box-col-12">
                                            ...
                                            <div class="ep-box-row ep-checkout-field-essentials ep-pt-3">
                                                ...
                                                <div class="ep-box-col-12 ep-d-flex ep-items-center ep-meta-box-data">
                                                    <table class="ep-table ep-table-striped ep-attendee-fields-modal-table ep-checkout-field-table">
                                                        <thead>
                                                            <tr>
                                                                <th><?php esc_html_e( 'Label', 'eventprime-event-calendar-management' ); ?>
                                                                </th>
                                                                <th><?php esc_html_e( 'Description', 'eventprime-event-calendar-management' ); ?>
                                                                </th>
                                                                <th><?php esc_html_e( 'Include', 'eventprime-event-calendar-management' ); ?>
                                                                </th>
                                                                <th><?php esc_html_e( 'Required', 'eventprime-event-calendar-management' ); ?>
                                                                </th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
                                                    ...
                                                    <table class="ep-table ep-table-striped ep-attendee-fields-modal-table ep-checkout-field-table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            foreach ( $get_field_data as $field ) {?>
                                                                <tr
                                                                    title="<?php echo esc_attr( sprintf( esc_html( 'Add %s field', 'eventprime-event-calendar-management' ), esc_attr( strtolower( $field->label ) ) ) ) ;?>">
                                                                    ...
                                                                    <td>
                                                                        <input type="checkbox"
                                                                            ...
                                                                            <?php if ( in_array( $field->id, $em_event_checkout_fields_data ) ) {
                                ...
                                <div class="ep-event-checkout-fields ep-box-row"><?php
                                    ...
                                    foreach( $em_event_checkout_fields_data as $field_data ) {
                                        if( isset( $event_checkout_fields_arr[$field_data] ) && ! empty( $event_checkout_fields_arr[$field_data] ) ) {?>
                                            <div class="ep-box-col-12 ep-bg-white"
                                                id="ep_event_checkout_fields_data_<?php echo esc_attr( $field_data );?>_top">
                                                <div
                                                    class="ep-border ep-rounded-1 ep-p-2 ep-mx-2 ep-mb-2 ep-d-flex ep-align-items-center ep-text-small">
                                            ...
                                            <div class="ep-box-col-12 ep-event-checkout-fields-expand-section"
                                                ...
                                                <div
                                                    class="checkout-field-options ep-border ep-rounded-1 ep-p-2 ep-py-4 ep-d-flex ep-justify-content-between ep-mx-2 ep-mb-2 ep-text-small">
                                                    <div class="ep-event-checkout-selected-fields-attributes">
                    ...
                    <div class="ep-box-row ep-mb-3 ep-event-checkout-fixed-fields panel ep_event_checkout_fields_panel"
                        ...
                        <div class="ep-box-col-12">
                            <div class="ep-text-small ep-alert ep-alert-warning ep-mx-2 ep-my-4">
                                <?php echo esc_html__( 'Booking fields are used to gether additional data from the user during checkout form Step 1. These field appear only once, unlike attendee fields. For example, Terms and Conditions, Additional Instructions etc.', 'eventprime-event-calendar-management' );?>
                            </div>
                        </div>
                        <div class="ep-box-col-12">
