jQuery( function( $ ) {
    ...
    $( document ).on( 'click', '#ep_enable_recurrence', function() {
        if( $( this ).prop( 'checked' ) == true ) {
            ...
            let chile_events_count = $( '#ep_event_count_child_events' ).val();
            if( chile_events_count && chile_events_count > 0 ) {
    ...
    function addOrRemoveDate( date, cdates ) {
        ...
        if( cdates.length > 0 ) {
            cdates.forEach(function ( cus_date, index ) {
                cdate_html += '<span class="ep-event-recurring-custom-date">' + cus_date + '</span>';
            });
        }
                ...
                $.each( all_offers, function( idx, data ) {
                    ...
                    offer_list_data += "<div class='ep-box-row ep-border ep-rounded ep-m-3 ep-bg-white ep-items-center ep-offer-list-class' id='"+new_offer_row_id+"' data-offer_row_data='"+new_ticket_offer_data+"'>";
                        ...
                        offer_list_data += '<div class="ep-box-col-4 ep-p-2">';
                            offer_list_data += '<span class="ep-offer-type">'+ ep_offer_type +'</span>';
                        offer_list_data += '</div>';
                        offer_list_data += '<div class="ep-box-col-1 ep-p-2"><span class="ep-ticket-offer-edit ep-text-primary" data-parent_id="'+new_offer_row_id+'">Edit</span></div>';
                        offer_list_data += '<div class="ep-box-col-1"><span class="ep-ticket-offer-delete ep-text-danger" data-parent_id="'+new_offer_row_id+'">Delete</span></div>';
                    offer_list_data += '</div>';
