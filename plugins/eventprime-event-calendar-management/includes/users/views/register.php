...
if( ! empty( $args->current_user ) && ! empty( $args->current_user->ID ) ) {?>
    ...
    <div class="emagic">
        <div id="ep_attendee_register_form_wrapper"><?php 
            $register_text = ep_global_settings_button_title('Register'); ?>
            <h2><?php echo esc_html( $register_text ); ?></h2>
            <?php $form = null;
            ...
            if ( ! empty( $form ) && $form->form_type == 1 ){
                ...
                <form id="ep_attendee_register_form" class="ep-attendee-register-form ep-shadow-sm ep-border ep-rounded ep-p-5 ep-mb-3" method="post">
                    ...
                    <?php if( ! empty( $args->register_username_show ) ) {?>
                        <div class="ep-form-row ep-form-group ep-mb-3">
                            <label for="user_name" class="ep-form-label">
                                <?php echo esc_html( stripslashes( $args->register_username_label ) ); ?>&nbsp;
                    ...
                    <div class="ep-form-row ep-form-group ep-mb-3">
                        <label for="email" class="ep-form-label">
                            <?php echo esc_html( stripslashes( $args->register_email_label ) ); ?>&nbsp;
                    ...
                    <?php if( ! empty( $args->register_password_show ) ) {?>
                        <div class="ep-form-row ep-form-group ep-mb-3">
                            <label for="password" class="ep-form-label">
                                <?php echo esc_html( stripslashes( $args->register_password_label ) ); ?>&nbsp;
                    ...
                    <?php if( ! empty( $args->register_repeat_password_show ) ) {?>
                        <div class="ep-form-row ep-form-group ep-mb-3">
                            <label for="repeat_password" class="ep-form-label">
                                <?php echo esc_html( stripslashes( $args->register_repeat_password_label ) ); ?>&nbsp;
                    ...
                    <?php if( ! empty( $args->register_phone_show ) ) {?>
                        <div class="ep-form-row ep-form-group ep-mb-3">
                            <label for="dob" class="ep-form-label">
                                <?php echo esc_html( stripslashes( $args->register_phone_label ) ); ?>&nbsp;
                    ...
                    <div class="ep-form-row ep-register-btn-section ep-form-group ep-mb-3">
                        ...
                        <button type="submit" class="ep-btn ep-btn-dark ep-mb-2 ep-py-2 ep-register-form-submit" name="ep_register" value="<?php esc_html_e( 'Register', 'eventprime-event-calendar-management' );?>" >
