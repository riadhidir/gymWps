...
class EventM_Venues_Admin {
	...
	public function add_event_venue_fields() { 
        ...
        <div class="form-field ep-venue-admin-instagram">
            ...
            <p class="emnote emeditor">
                <?php esc_html_e('Instagram page URL of the Event Site, if available. Eg.:https://www.instagram.com/stories/XYZ', 'eventprime-event-calendar-management'); ?>
            </p>
        </div>
        ...
        <div class="form-field ep-venue-admin-image-wrap">
            ...
            <div class="ep-box-w-100">
                ...
                <p class="emnote emeditor">
                    <?php esc_html_e(' Image or icon of the Event Organizer. Will be displayed on the Event Organizer directory page.', 'eventprime-event-calendar-management'); ?>
                </p>
            </div>
        </div>
        <div class="form-field ep-venue-admin-featured">
            <label for="is_featured">
                ...
                <p class="emnote emeditor">
                    <?php esc_html_e('Check if you want to make this event site featured.', 'eventprime-event-calendar-management'); ?>
                </p>
            </label>
        </div>
		<?php
