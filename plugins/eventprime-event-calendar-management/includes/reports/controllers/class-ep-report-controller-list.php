...
class EventM_Report_Controller_List {
    ...
    public function eventprime_report_filters(){
        ...
        do_action('ep_bookings_report_stat',$booking_data);
        ...
        do_action('ep_bookings_report_bookings_list',$booking_data);
    ...
    public function ep_load_more_report_booking($filter_args){
        ...
        do_action('ep_booking_reports_booking_list_load_more',$bookings_data);
