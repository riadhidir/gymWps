        ...
        <div class="ep-box-row">
            <?php if( ! empty( $args->em_id ) ) {
                ...
                if( ! empty( $user->ID ) || ( isset( $args->em_order_info['guest_booking'] ) && $args->em_order_info['guest_booking'] == 1 ) ) {
                    ...
                    <div class="ep-box-col-6 ep-text-start ep-mb-3 ep-pl-0">
                    ...
                    <div class="ep-box-col-6 ep-text-end ep-mb-3 ep-pr-0">
                        <a href="<?php echo esc_url( get_permalink( ep_get_global_settings( 'profile_page' ) ) );?>" target="_blank">
                        ...
                        <div class="ep-box-row">
                            ...
                            <div class="ep-box-col-3 ep-py-4 ep-text-small">
                                ...
                                <div class="ep-text-small ep-mt-4">
                                    ...
                                    <div class="">
                                        ...
                                        <span class="ep-text-success">
                                            <?php echo esc_html_e( ucfirst( $args->em_payment_log['payment_status'] ), 'eventprime-event-calendar-management' );?>
                                        </span>
                                    </div>
                                    <div class="">
                                        <span class="ep-mr-2">
                                    ...
                                    <div class="">
                                        ...
                                        <span>
                                            <?php echo esc_html_e( ucfirst( $args->em_payment_log['payment_gateway'] ), 'eventprime-event-calendar-management' );?>
                                        </span>
                                    </div>
                                </div>
                            </div>
                            <div class="ep-box-col-3 ep-p-4 ep-text-small">
                                <div class="ep-pt-4">
                                    ...
                                    if ( ! empty( $args->event_data->venue_details ) ) {
                                    ...
                                    if( ! empty( $gcal_starts ) && ! empty( $gcal_ends ) ) {?>
                                        <div class="ep-text-small ep-mb-2 ep-lh-0">
                                            ...
                                            <div class="ep-text-small ep-mb-2 ep-lh-0">
                                                <a href="javascript:void(0)" id="ep_event_ical_export" data-event_id="<?php echo esc_attr($args->event_data->em_id); ?>">
                                                    <span class="material-icons-outlined ep-fs-6 ep-align-middle">event</span>
                                    ...
                                    <?php if( ! empty( $args->event_data->venue_details ) && ! empty( $args->event_data->venue_details->em_address ) ) {?>
                                        <div class="ep-text-small ep-mb-2 ep-lh-0">
                                            <a target="_blank" href="https://www.google.com/maps?saddr=My+Location&daddr=<?php echo urlencode( $args->event_data->venue_details->em_address ); ?>" >
                                                <span class="material-icons-outlined ep-fs-6 ep-align-middle">directions_car</span>
                                        ...
                                        if( ! empty( $org_email ) ) {?>
                                            <div class="ep-text-small ep-mb-2 ep-lh-0">
                                                <a href="mailto:<?php echo esc_html( $org_email );?>">
                                                    <span class="material-icons-outlined ep-fs-6 ep-align-middle">work_outline</span>
                                    ...
                                    if( 1 == $args->event_data->em_allow_cancellations && ( 'completed' == $args->em_status || 'pending' == $args->em_status ) ) {?>
                                        <div class="ep-text-small ep-cursor ep-text-danger ep-di-flex ep-align-items-center" ep-modal-open="ep_booking_cancellation_modal">
                                            <span class="material-icons-outlined ep-fs-6 align-middle">block</span>
