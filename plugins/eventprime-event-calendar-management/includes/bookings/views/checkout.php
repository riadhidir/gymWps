    ...
    <div class="emagic ep-position-relative" id="ep_event_checkout_page">
        ...
        <div class="ep-box-wrap">
            <div class="ep-box-row ep-mt-5 ep-mb-3">
                <div class="ep-box-col-2 ep-pr-0 ep-border-right ep-border-warning ep-border-3">
                ...
                <div class="ep-box-col-10 ep-text-start">
                    <div class="ep-fs-3 ep-fw-bold ep-mb-2"><?php echo esc_html( $args->event->name );?></div>
                    <div class="ep-fs-6">
                        <div class="ep-d-inline-flex ep-align-items-center"><?php echo esc_html( $args->event->fstart_date );?>, <?php echo esc_html( ep_convert_time_with_format( $args->event->em_start_time ) );?> 
            ...
            <div class="ep-box-row ep-mb-3">
                <form name="checkout_form" class="needs-validation ep-box-col-12" novalidate="" id="ep_event_checkout_form">
                    ...
                    <div class="ep-box-row ep-g-5 ep-flex-row-reverse">
                        ...
                        <!-- Left side box -->
                        <div class="ep-box-col-8 ep-text-small">
                                                    ...
                                                    <div class="ep-event-booking-attendee-head ep-box-row ep-overflow-hidden ep-border ep-rounded-top  ep-mb-0">
                                                        <div class="ep-box-col-12 ep-py-3 ep-d-flex ep-justify-content-between">
                                                            <span class="ep-fs-6 ep-fw-bold">
                                                                <?php esc_html_e( 'Ticket', 'eventprime-event-calendar-management' ); echo ' ' . esc_html( $ticket_num );?>
                                                            </span>
