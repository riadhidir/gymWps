jQuery( function( $ ) {
                    ...
                    if( field_data && !field_id ){
                        let newTr = '<tr id="ep-checkout-field-'+field_data.field_id+'">';
                            ...
                            newTr += '<td><div class="ep-checkout-field-action">';
                                newTr += '<span class="ep-edit-checkout-field" data-field_id="'+field_data.field_id+'" data-field_label="'+field_data.label+'" data-field_type="'+field_data.type+'"><i class="ep-color-primary ep-cursor">'+ep_admin_settings.edit_text+'</i></span>';
                                newTr += '<span class="ep-delete-checkout-field ep-open-modal" data-id="ep_event_settings_delete_checkout_field" data-field_id="'+field_data.field_id+'" data-field_label="'+field_data.label+'" data-field_type="'+field_data.type+'"><i class="ep-text-danger ep-cursor ep-ml-3">'+ep_admin_settings.delete_text+'</i></span>';
                            newTr += '</div></td>';
                        newTr += '</tr>';
    ...
    function ep_submit_default_payment_processor_ajax( ele ){
        //let ep_default_payment_processor = $('input:checkbox[name=ep_default_payment_processor]:checked').val();
