...
class EventM_Admin_Controller_Settings {
    ...
    public function save_regular_settings() {
        ...
        $global_settings_data->time_format                         = sanitize_text_field($form_data['time_format']);
    ...
    public function save_front_events_settings(){
        ...
        $global_settings_data->show_qr_code_on_single_event    = isset( $form_data['show_qr_code_on_single_event'] ) ? (int) $form_data['show_qr_code_on_single_event'] : 0;
