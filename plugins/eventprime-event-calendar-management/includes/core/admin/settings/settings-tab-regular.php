...
<div class="ep-setting-tab-content">
    <h2><?php esc_html_e( 'General', 'eventprime-event-calendar-management' );?></h2>
    ...
    <tbody>
        ...
        <tr valign="top">
            <th scope="row" class="titledesc">
                <label for="datepicker_format">
                    <?php esc_html_e( 'Date Field Format', 'eventprime-event-calendar-management' );?>
                </label>
            </th>
            <td class="forminp forminp-text">
        ...
        <tr valign="top">
            ...
            <td class="forminp forminp-text">
                ...
                <div class="ep-help-tip-info ep-my-2 ep-text-muted"><?php esc_html_e( 'Fornt size for frontend.', 'eventprime-event-calendar-management' );?></div>
            </td>
        </tr>
