        ...
        <tr valign="top">
                <th scope="row" class="titledesc">
                    <label for="hide_old_bookings">
                        <?php esc_html_e( 'Hide Bookings Of Past Events', 'eventprime-event-calendar-management' );?>
                    </label>
                </th>
                <td class="forminp forminp-text">
                    <label class="ep-toggle-btn">
    ...
    <tbody>
        <tr valign="top">
            ...
            <td class="forminp forminp-text">
                ...
                <div class="ep-help-tip-info ep-my-2 ep-text-muted"><?php esc_html_e( 'The number of events to fetch on first page load and on clicking \'Load More\' button.', 'eventprime-event-calendar-management' );?></div>
            </td>
        </tr>
        <tr valign="top" class="ep_enable_card_view_custom_value_child" style="<?php echo ( ( $global_options->default_cal_view == 'card' || $global_options->default_cal_view == 'masonry' || $global_options->default_cal_view == 'list' ) &&  $global_options->show_no_of_events_card == 'custom' ) ? '' : 'display:none;';?>">
            <th scope="row" class="titledesc">
...
<div class="ep-setting-tab-content">
    <h2><?php esc_html_e( 'Single Event View Settings', 'eventprime-event-calendar-management' );?></h2>
</div>
<table class="form-table">
    <tbody>
