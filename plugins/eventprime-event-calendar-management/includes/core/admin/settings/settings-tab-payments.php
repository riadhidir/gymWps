...
<div class="ep-payments-tab-content">
    <h2><?php esc_html_e( 'Payments', 'eventprime-event-calendar-management' );?></h2>
    <input type="hidden" name="em_setting_type" value="payment_settings">
</div>
<?php if(isset( $_GET['section'] )):?>
    <div class="ep-payment-settings">
        ...
        $active_payment_setting = strtolower($_GET['section']);
        if( count( $payments_settings ) ) {?>
            <div class="ep-payment-setting-page" id="ep-payment-setting-<?php echo esc_attr( $active_payment_setting );?>">
                <div class="ep-payment-setting-title">
                    ...
                    <?php }else{ ?>
                        <div class="ep-payment-method-title"><?php echo esc_html( $payments[$active_payment_setting]['method'] );?> </div>
                    <?php }?> 
                </div>
