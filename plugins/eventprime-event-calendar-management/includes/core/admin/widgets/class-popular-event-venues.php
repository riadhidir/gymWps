            ...
            $html = '<div class="widget widget_popular_venues ep-widgets"><div class="widget-content">';
                ...
                if( ! empty( $venues->terms ) ){
                    ...
                    foreach ( $venues->terms as $venue ) {
                        $html .= '<div id="ep-popular-venues"  class="ep-mw-wrap ep-widget-block-wrap ep-d-flex ep-p-2 ep-my-3 ep-shadow-sm ep-border ep-rounded-1">';
                            $title = $venue->name;
                            ...
                            $html .= '</div>';
                            $html .= '<div class="ep-fdata"><div class="ep-fname ep-mt-2"><a href="'.esc_url( $venue->venue_url ).'">'.esc_attr( $venue->name ).'</a></div>';              
                            $html .= '</div>';
                        $html .= '</div>';
                    }
                }else{
