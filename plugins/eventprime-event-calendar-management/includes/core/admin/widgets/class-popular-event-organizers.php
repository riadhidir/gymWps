            ...
            $html = '<div class="widget widget_popular_orgainzers ep-widgets"><div class="widget-content">';
                ...
                if( ! empty( $organizers->terms ) ){
                    ...
                    foreach ( $organizers->terms as $organizer ) {
                        $html .= '<div id="ep-popular-organizers"  class="ep-mw-wrap ep-widget-block-wrap ep-d-flex ep-p-2 ep-my-3 ep-shadow-sm ep-border ep-rounded-1">';
                            ...
                            $html .= '</div>';
                            $html .= '<div class="ep-fdata"><div class="ep-fname ep-mt-2"><a href="'.esc_url( $organizer->organizer_url ).'">'.esc_attr( $organizer->name ).'</a></div>';              
                            $html .= '</div>';
                        $html .= '</div>';
                    }
                }else{
