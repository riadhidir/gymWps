            ...
            $html = '<div class="widget widget_featured_performers ep-widgets"><div class="widget-content">';
                ...
                if( ! empty( $performers->posts ) ){
                    ...
                    foreach ( $performers->posts as $performer ) {
                        $html .= '<div class="ep-featured-performer ep-widget-block-wrap ep-d-flex ep-p-2 ep-my-3 ep-shadow-sm ep-border ep-rounded-1">';
                            ...
                            $html .= '</div>';
                            $html .= '<div class="ep-fdata"><div class="ep-fname ep-mt-2"><a href="'.esc_url( $performer->performer_url ).'">'.esc_attr( $performer->name ).'</a></div>';              
