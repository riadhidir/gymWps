...
<div class="emagic ep-frontend ep-shortcode-page">
    <div class="ep-sc-wrap ep-box-wrap">
        <div class="ep-sc-blocks ep-box-row">
            <div class="ep-sc-block-row ep-box-col-12 ep-scpagetitle ep-py-4 ep-my-4 ep-text-center"> <b><?php _e('EventPrime','eventprime-event-calendar-management') ?></b> <span class=""><?php _e('Shortcodes','eventprime-event-calendar-management') ?></span> </div>
        </div>
        ...
        <div class="ep-escblock-wrap ep-box-row">
            ...
            <div class="ep-sc-block ep-box-col-4">
                <div class="ep-escsubblock ep-bg-white ep-p-3 ep-position-relative ep-mb-4 ep-rounded-1">
                    <div class="ep-scblock ep-sctitle ep-fw-bold ep-text-center ep-pb-2"><?php _e('All Events', 'eventprime-event-calendar-management') ?>
                        <div style="display: none" class="ep-shorcode-copied"><?php esc_html_e('Shortcode Copied', 'eventprime-event-calendar-management'); ?></div>
                        <div class="ep-scblock-menu ep-sc-menu ep-position-absolute " style="right: 5px;top: 14px;" onclick="pg_shortcode_dropdown_menu(this)">
                            <span class="material-icons ep-cursor">more_vert</span>
                            <ul class="ep-sc-dropdown" style="display: none;">
                                <li class="ep-sc-dropdown-item"><a href="javascript:void(0)" onclick="pg_copy_shortcode(document.getElementById('ep-all-event-page'))">Copy Shortcode</a></li> 
                                <li class="ep-sc-dropdown-item"><a href="<?php echo admin_url('post.php?post='.$options->events_page.'&action=edit'); ?>">New Page with Shortcode</a></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="ep-sc-block ep-box-col-4">
                <div class="ep-escsubblock ep-bg-white ep-p-3 ep-position-relative ep-mb-4 ep-rounded-1">
                    <div class="ep-scblock ep-sctitle ep-fw-bold ep-text-center ep-pb-2"><?php _e('All Event Types', 'eventprime-event-calendar-management') ?>
                        <div style="display: none" class="ep-shorcode-copied"><?php esc_html_e('Shortcode Copied', 'eventprime-event-calendar-management'); ?></div>
                        <div class="ep-scblock-menu ep-sc-menu ep-position-absolute " style="right: 5px;top: 14px;" onclick="pg_shortcode_dropdown_menu(this)">
                            <span class="material-icons ep-cursor">more_vert</span>
                            <ul class="ep-sc-dropdown" style="display: none;">
                                <li class="ep-sc-dropdown-item"><a href="javascript:void(0)" onclick="pg_copy_shortcode(document.getElementById('ep-all-event-types-page'))">Copy Shortcode</a></li> 
            ...
            <div class="ep-sc-block ep-box-col-4">
                <div class="ep-escsubblock ep-bg-white ep-p-3 ep-position-relative ep-mb-4 ep-rounded-1">
                    <div class="ep-scblock ep-sctitle ep-fw-bold ep-text-center ep-pb-2"><?php _e('All Sites/Locations', 'eventprime-event-calendar-management') ?>
                        <div style="display: none" class="ep-shorcode-copied"><?php esc_html_e('Shortcode Copied', 'eventprime-event-calendar-management'); ?></div>
                        <div class="ep-scblock-menu ep-sc-menu ep-position-absolute " style="right: 5px;top: 14px;" onclick="pg_shortcode_dropdown_menu(this)">
                            <span class="material-icons ep-cursor">more_vert</span>
                            <ul class="ep-sc-dropdown" style="display: none;">
                                <li class="ep-sc-dropdown-item"><a href="javascript:void(0)" onclick="pg_copy_shortcode(document.getElementById('ep-all-event-sites-page'))">Copy Shortcode</a></li> 
                                <li class="ep-sc-dropdown-item"><a href="<?php echo admin_url('post.php?post='.$options->venues_page.'&action=edit'); ?>">New Page with Shortcode</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="ep-scblock ep-sc-format-row ep-d-flex ep-justify-content-between ep-py-2">
            ...
            <div class="ep-sc-block ep-box-col-4">
                <div class="ep-escsubblock ep-bg-white ep-p-3 ep-position-relative ep-mb-4 ep-rounded-1">
                    <div class="ep-scblock ep-sctitle ep-fw-bold ep-text-center ep-pb-2"><?php _e('Event Organizers', 'eventprime-event-calendar-management') ?>
                        <div style="display: none" class="ep-shorcode-copied"><?php esc_html_e('Shortcode Copied', 'eventprime-event-calendar-management'); ?></div>
                        <div class="ep-scblock-menu ep-sc-menu ep-position-absolute " style="right: 5px;top: 14px;" onclick="pg_shortcode_dropdown_menu(this)">
                            <span class="material-icons ep-cursor">more_vert</span>
                            <ul class="ep-sc-dropdown" style="display: none;">
                                <li class="ep-sc-dropdown-item"><a href="javascript:void(0)" onclick="pg_copy_shortcode(document.getElementById('ep-all-event-organizers-page'))">Copy Shortcode</a></li> 
                                <li class="ep-sc-dropdown-item"><a href="<?php echo admin_url('post.php?post='.$options->event_organizers.'&action=edit'); ?>">New Page with Shortcode</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="ep-scblock ep-sc-format-row ep-d-flex ep-justify-content-between ep-py-2">
            ...
            <div class="ep-sc-block ep-box-col-4">
                <div class="ep-escsubblock ep-bg-white ep-p-3 ep-position-relative ep-mb-4 ep-rounded-1">
                    <div class="ep-scblock ep-sctitle ep-fw-bold ep-text-center ep-pb-2"><?php _e('All Performers', 'eventprime-event-calendar-management') ?>
                        <div style="display: none" class="ep-shorcode-copied"><?php esc_html_e('Shortcode Copied', 'eventprime-event-calendar-management'); ?></div>
                        <div class="ep-scblock-menu ep-sc-menu ep-position-absolute " style="right: 5px;top: 14px;" onclick="pg_shortcode_dropdown_menu(this)">
                            <span class="material-icons ep-cursor">more_vert</span>
                            <ul class="ep-sc-dropdown" style="display: none;">
                                <li class="ep-sc-dropdown-item"><a href="javascript:void(0)" onclick="pg_copy_shortcode(document.getElementById('ep-all-event-performers-page'))">Copy Shortcode</a></li> 
                                <li class="ep-sc-dropdown-item"><a href="<?php echo admin_url('post.php?post='.$options->performers_page.'&action=edit'); ?>">New Page with Shortcode</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="ep-scblock ep-sc-format-row ep-d-flex ep-justify-content-between ep-py-2">
                    ...
                    <div class="ep-scblock-hide" style="display: none;">
                        <div class="ep-scblock ep-sc-example-row ep-d-flex ep-justify-content-between ep-py-2">
                            <div class="ep-sc-title ep-fw-bold"><?php esc_html_e('Example', 'eventprime-event-calendar-management'); ?></div> 
                            <div class="ep-sc-dec ep-box-w-65">[em_performers display_style="grid/colored_grid/rows" limit="{NUMBER}" cols="{NUMBER}" load_more="0 or 1" search="0 or 1" featured="0 or 1" popular="0 or 1"]</div>
            ...
            <div class="ep-sc-block ep-box-col-4">
                <div class="ep-escsubblock ep-bg-white ep-p-3 ep-position-relative ep-mb-4 ep-rounded-1">
                    <div class="ep-scblock ep-sctitle ep-fw-bold ep-text-center ep-pb-2"><?php _e('Event Sponsors', 'eventprime-event-calendar-management') ?>
                        <div style="display: none" class="ep-shorcode-copied"><?php esc_html_e('Shortcode Copied', 'eventprime-event-calendar-management'); ?></div>
                        <div class="ep-scblock-menu ep-sc-menu ep-position-absolute " style="right: 5px;top: 14px;" onclick="pg_shortcode_dropdown_menu(this)">
                            <span class="material-icons ep-cursor">more_vert</span>
                            <ul class="ep-sc-dropdown" style="display: none;">
                                <li class="ep-sc-dropdown-item"><a href="javascript:void(0)" onclick="pg_copy_shortcode(document.getElementById('ep-all-event-sponsors-page'))">Copy Shortcode</a></li> 
                                <li class="ep-sc-dropdown-item"><a href="<?php echo admin_url('post.php?post='.$options->sponsor_page.'&action=edit'); ?>">New Page with Shortcode</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="ep-scblock ep-sc-format-row ep-d-flex ep-justify-content-between ep-py-2">
            ...
            <div class="ep-sc-block ep-box-col-4">
                <div class="ep-escsubblock ep-bg-white ep-p-3 ep-position-relative ep-mb-4 ep-rounded-1">
                    <div class="ep-scblock ep-sctitle ep-fw-bold ep-text-center ep-pb-2"><?php _e('Display Individual Event Type', 'eventprime-event-calendar-management') ?>
                        <div style="display: none" class="ep-shorcode-copied"><?php esc_html_e('Shortcode Copied', 'eventprime-event-calendar-management'); ?></div>
                        <div class="ep-scblock-menu ep-sc-menu ep-position-absolute " style="right: 5px;top: 14px;" onclick="pg_shortcode_dropdown_menu(this)">
                            <span class="material-icons ep-cursor">more_vert</span>
                            <ul class="ep-sc-dropdown" style="display: none;">
                                <li class="ep-sc-dropdown-item"><a href="javascript:void(0)" onclick="pg_copy_shortcode(document.getElementById('ep-individual-event-type-page'))">Copy Shortcode</a></li> 
                                <li class="ep-sc-dropdown-item"><a href="#">New Page with Shortcode</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="ep-scblock ep-sc-format-row ep-d-flex ep-justify-content-between ep-py-2">
            ...
            <div class="ep-sc-block ep-box-col-4">
                <div class="ep-escsubblock ep-bg-white ep-p-3 ep-position-relative ep-mb-4 ep-rounded-1">
                    <div class="ep-scblock ep-sctitle ep-fw-bold ep-text-center ep-pb-2"><?php _e('Display Individual Event Site/Location', 'eventprime-event-calendar-management') ?>
                        <div style="display: none" class="ep-shorcode-copied"><?php esc_html_e('Shortcode Copied', 'eventprime-event-calendar-management'); ?></div>
                        <div class="ep-scblock-menu ep-sc-menu ep-position-absolute " style="right: 5px;top: 14px;" onclick="pg_shortcode_dropdown_menu(this)">
                            <span class="material-icons ep-cursor">more_vert</span>
                            <ul class="ep-sc-dropdown" style="display: none;">
                                <li class="ep-sc-dropdown-item"><a href="javascript:void(0)" onclick="pg_copy_shortcode(document.getElementById('ep-individual-event-site-page'))">Copy Shortcode</a></li> 
                                <li class="ep-sc-dropdown-item"><a href="#">New Page with Shortcode</a></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="ep-sc-block ep-box-col-4">
                <div class="ep-escsubblock ep-bg-white ep-p-3 ep-position-relative ep-mb-4 ep-rounded-1">
                    <div class="ep-scblock ep-sctitle ep-fw-bold ep-text-center ep-pb-2"><?php _e('Display Individual Event Organizer', 'eventprime-event-calendar-management') ?>
                        <div style="display: none" class="ep-shorcode-copied"><?php esc_html_e('Shortcode Copied', 'eventprime-event-calendar-management'); ?></div>
                        <div class="ep-scblock-menu ep-sc-menu ep-position-absolute " style="right: 5px;top: 14px;" onclick="pg_shortcode_dropdown_menu(this)">
                            <span class="material-icons ep-cursor">more_vert</span>
                            <ul class="ep-sc-dropdown" style="display: none;">
                                <li class="ep-sc-dropdown-item"><a href="javascript:void(0)" onclick="pg_copy_shortcode(document.getElementById('ep-individual-event-organizer-page'))">Copy Shortcode</a></li> 
                                <li class="ep-sc-dropdown-item"><a href="#">New Page with Shortcode</a></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="ep-sc-block ep-box-col-4">
                <div class="ep-escsubblock ep-bg-white ep-p-3 ep-position-relative ep-mb-4 ep-rounded-1">
                    <div class="ep-scblock ep-sctitle ep-fw-bold ep-text-center ep-pb-2"><?php _e('Display Individual Performer', 'eventprime-event-calendar-management') ?>
                        <div style="display: none" class="ep-shorcode-copied"><?php esc_html_e('Shortcode Copied', 'eventprime-event-calendar-management'); ?></div>
                        <div class="ep-scblock-menu ep-sc-menu ep-position-absolute " style="right: 5px;top: 14px;" onclick="pg_shortcode_dropdown_menu(this)">
                            <span class="material-icons ep-cursor">more_vert</span>
                            <ul class="ep-sc-dropdown" style="display: none;">
                                <li class="ep-sc-dropdown-item"><a href="javascript:void(0)" onclick="pg_copy_shortcode(document.getElementById('ep-individual-performer-page'))">Copy Shortcode</a></li> 
                                <li class="ep-sc-dropdown-item"><a href="#">New Page with Shortcode</a></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="ep-sc-block ep-box-col-4">
                <div class="ep-escsubblock ep-bg-white ep-p-3 ep-position-relative ep-mb-4 ep-rounded-1">
                    <div class="ep-scblock ep-sctitle ep-fw-bold ep-text-center ep-pb-2"><?php _e('Display Individual Sponsor', 'eventprime-event-calendar-management') ?>
                        <div style="display: none" class="ep-shorcode-copied"><?php esc_html_e('Shortcode Copied', 'eventprime-event-calendar-management'); ?></div>
                        <div class="ep-scblock-menu ep-sc-menu ep-position-absolute " style="right: 5px;top: 14px;" onclick="pg_shortcode_dropdown_menu(this)">
                            <span class="material-icons ep-cursor">more_vert</span>
                            <ul class="ep-sc-dropdown" style="display: none;">
                                <li class="ep-sc-dropdown-item"><a href="javascript:void(0)" onclick="pg_copy_shortcode(document.getElementById('ep-individual-sponsor-page'))">Copy Shortcode</a></li> 
                                <li class="ep-sc-dropdown-item"><a href="#">New Page with Shortcode</a></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="ep-sc-block ep-box-col-4">
                <div class="ep-escsubblock ep-bg-white ep-p-3 ep-position-relative ep-mb-4 ep-rounded-1">
                    <div class="ep-scblock ep-sctitle ep-fw-bold ep-text-center ep-pb-2"><?php _e('User Account Area', 'eventprime-event-calendar-management') ?>
                        <div style="display: none" class="ep-shorcode-copied"><?php esc_html_e('Shortcode Copied', 'eventprime-event-calendar-management'); ?></div>
                        <div class="ep-scblock-menu ep-sc-menu ep-position-absolute " style="right: 5px;top: 14px;" onclick="pg_shortcode_dropdown_menu(this)">
                            <span class="material-icons ep-cursor">more_vert</span>
                            <ul class="ep-sc-dropdown" style="display: none;">
                                <li class="ep-sc-dropdown-item"><a href="javascript:void(0)" onclick="pg_copy_shortcode(document.getElementById('ep-user-profile-page'))">Copy Shortcode</a></li> 
                                <li class="ep-sc-dropdown-item"><a href="<?php echo admin_url('post.php?post='.$options->profile_page.'&action=edit'); ?>">New Page with Shortcode</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="ep-scblock ep-sc-format-row ep-d-flex ep-justify-content-between ep-py-2">
            ...
            <div class="ep-sc-block ep-box-col-4">
                <div class="ep-escsubblock ep-bg-white ep-p-3 ep-position-relative ep-mb-4 ep-rounded-1">
                    <div class="ep-scblock ep-sctitle ep-fw-bold ep-text-center ep-pb-2"><?php _e('Processes Event Bookings', 'eventprime-event-calendar-management') ?>
                        <div style="display: none" class="ep-shorcode-copied"><?php esc_html_e('Shortcode Copied', 'eventprime-event-calendar-management'); ?></div>
                        <div class="ep-scblock-menu ep-sc-menu ep-position-absolute " style="right: 5px;top: 14px;" onclick="pg_shortcode_dropdown_menu(this)">
                            <span class="material-icons ep-cursor">more_vert</span>
                            <ul class="ep-sc-dropdown" style="display: none;">
                                <li class="ep-sc-dropdown-item"><a href="javascript:void(0)" onclick="pg_copy_shortcode(document.getElementById('ep-event-booking-page'))">Copy Shortcode</a></li> 
                                <li class="ep-sc-dropdown-item"><a href="<?php echo admin_url('post.php?post='.$options->booking_page.'&action=edit'); ?>">New Page with Shortcode</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="ep-scblock ep-sc-format-row ep-d-flex ep-justify-content-between ep-py-2">
            ...
            <div class="ep-sc-block ep-box-col-4">
                <div class="ep-escsubblock ep-bg-white ep-p-3 ep-position-relative ep-mb-4 ep-rounded-1">
                    <div class="ep-scblock ep-sctitle ep-fw-bold ep-text-center ep-pb-2"><?php _e('Display Event Submission Form', 'eventprime-event-calendar-management') ?>
                        <div style="display: none" class="ep-shorcode-copied"><?php esc_html_e('Shortcode Copied', 'eventprime-event-calendar-management'); ?></div>
                        <div class="ep-scblock-menu ep-sc-menu ep-position-absolute " style="right: 5px;top: 14px;" onclick="pg_shortcode_dropdown_menu(this)">
                            <span class="material-icons ep-cursor">more_vert</span>
                            <ul class="ep-sc-dropdown" style="display: none;">
                                <li class="ep-sc-dropdown-item"><a href="javascript:void(0)" onclick="pg_copy_shortcode(document.getElementById('ep-event-submit-form-page'))">Copy Shortcode</a></li> 
                                <li class="ep-sc-dropdown-item"><a href="#">New Page with Shortcode</a></li>
                            </ul>
                        </div>
                    </div>
