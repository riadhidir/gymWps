        ...
        <div class="ep-box-row">    
            <div class="ep-box-col-12 ">
                <div class="ep-ext-list-title ep-fw-bold ep-fs-5 ep-d-flex ep-align-items-center ep-content-center ">
                    <span class="ep-border-right ep-px-2"><?php echo esc_html('Official Extensions'); ?></span>
                    <span class="ep-box-sep ep-border-right-2 ep-border-right ep-mr-1 ep-ml-1"></span>
                    <span class="ep-scblock-mg-logo ep-lh-0">
                        <img src="<?php echo esc_url(EP_BASE_URL . 'includes/assets/images/mg-logo.png'); ?>" >
                    </span>
                </div>
            </div>
        </div>
    ...
    <div class="ep-extensions-box-wrap ep-box-wrap">
        <div class="ep-box-row ep-g-4">
            ...
            foreach ( $ext_list as $ext ) {
                ...
                <div class="ep-box-col-3 ep-ext-card <?php echo $ext_details['is_free'] == 0 ? 'paid-extensions' : 'free-extensions';?>">
                        ...
                        <div class="ep-card-body">
                            <div class="ep-box-row ep-box-h-100">
                                ...
                                <div class="ep-box-col-9">
                                    <div class="ep-card-title ep-fs-6 ep-fw-bold ep-mb-1"> <?php echo $ext;?></div>
